...
# CSS for multi-pin library symbols (used as-is). pin=/to=/along=/side= for 2-pin parts.
SchRegion("usb", left=12, top=10, width=180, height=115)
SchPlace("J1", parent="usb", left=80, top=12)
SchPlace("R_CC1", pin="1", to="J1.CC1", gap=7.62)
SchPlace("R_CC2", pin="1", to="J1.CC2", gap=7.62)
SchPlace("U3", pin="I/O1", to="J1.DP1", side="bottom", gap=12.7)

SchRegion("pwr", left=210, top=10, width=155, height=115)
SchPlace("U2", parent="pwr", left=55, top=28)
SchPlace("C_VBUS", pin="1", to="U2.VIN", gap=10.16)
SchPlace("C_VBUS_HF", pin="1", along="C_VBUS.1", side="bottom", gap=12.7)
SchPlace("C_3V3", pin="1", to="U2.VOUT", gap=10.16)
SchPlace("C_3V3_HF", pin="1", along="C_3V3.1", side="bottom", gap=12.7)

SchRegion("mcu", left=12, top=140, width=380, height=145)
SchPlace("U1", parent="mcu", left=185, top=10)
SchPlace("C_MCU", pin="1", to="U1.3V3", gap=12.7)
SchPlace("C_MCU_HF", pin="1", along="C_MCU.1", side="left", gap=10.16)
SchPlace("R_EN", pin="2", to="U1.EN", gap=12.7)
SchPlace("C_EN", pin="1", along="R_EN.2", side="left", gap=10.16)
SchPlace("SW_RST", pin="1", along="C_EN.1", side="left", gap=10.16)
SchPlace("R_BOOT", pin="2", to="U1.IO9", gap=12.7)
SchPlace("SW_BOOT", pin="1", along="R_BOOT.2", side="left", gap=10.16)
SchPlace("R_LED", pin="1", to="U1.IO10", gap=12.7)
SchPlace("D1", pin="A", to="R_LED.2", gap=5.08)
