...
| `PCBC_PATTERNS=off` restores the pre-R2 plan exactly — one env check around one call, and every copper-bar number on all five boards comes back | `test_patterns.py::test_patterns_off_claims_nothing_and_is_a_rollback`, `docs/r2-measurements.md` S4 |
